...
| data.full_zip_url                     | string | https://cdn-mineru.openxlab.org.cn/ pdf/018e53ad-d4f1-475d-b380-36bf24db9914.zip | 文件解析结果压缩包，文件详细说明请参考：https://opendatalab.github.io/MinerU/reference/output_files/ |
...
| -60016 | 文件转换失败                  | 文件转换为指定格式失败，可以尝试其他格式导出或重             |